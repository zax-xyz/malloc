...
int main() {
    ...
    virtual_info(virtual_heap);
    printf("\n");
    virtual_free(virtual_heap, (uint8_t*) virtual_heap + 1024);
    virtual_info(virtual_heap);
    printf("\n");
    virtual_malloc(virtual_heap, 256);
    virtual_info(virtual_heap);
    ...
    virtual_info(virtual_heap);
    printf("\n");
    virtual_free(virtual_heap, (uint8_t*) virtual_heap + 1024 + 256 * 2);
    virtual_info(virtual_heap);
    printf("\n");
    virtual_free(virtual_heap, (uint8_t*) virtual_heap + 1024);
    virtual_info(virtual_heap);
    printf("\n");
    virtual_free(virtual_heap, (uint8_t*) virtual_heap + 1024 + 256);
    virtual_info(virtual_heap);
    printf("\n");
